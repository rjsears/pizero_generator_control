...
const helpLinks = [
  ...
  },
  {
    ...
    icon: BoltIcon,
    links: [
      { name: 'Generator Controls', url: 'https://rjsears.github.io/pizero_generator_control/GENERATOR/', description: 'Start, stop, and monitor generator operations', external: true },
      { name: 'Scheduling Guide', url: 'https://rjsears.github.io/pizero_generator_control/SCHEDULING/', description: 'Set up automated generator schedules', external: true },
      { name: 'GenSlave Setup', url: 'https://rjsears.github.io/pizero_generator_control/GENSLAVE/', description: 'Configure remote GenSlave monitoring', external: true },
      { name: 'Victron Integration', url: 'https://rjsears.github.io/pizero_generator_control/VICTRON/', description: 'Victron GPIO signal detection', external: true },
    ]
  },
  {
    ...
    icon: CpuChipIcon,
    links: [
      { name: 'Cloudflare Setup', url: 'https://rjsears.github.io/pizero_generator_control/CLOUDFLARE/', description: 'Cloudflare tunnel and DNS configuration', external: true },
      { name: 'Tailscale Setup', url: 'https://rjsears.github.io/pizero_generator_control/TAILSCALE/', description: 'Tailscale VPN integration', external: true },
      { name: 'Notifications', url: 'https://rjsears.github.io/pizero_generator_control/NOTIFICATIONS/', description: 'Email and Apprise notification setup', external: true },
      { name: 'Troubleshooting', url: 'https://rjsears.github.io/pizero_generator_control/TROUBLESHOOTING/', description: 'Common issues and solutions', external: true },
    ]
  },
  {
    ...
    links: [
      { name: 'Full Documentation', url: 'https://rjsears.github.io/pizero_generator_control/', description: 'Complete project documentation site', external: true },
