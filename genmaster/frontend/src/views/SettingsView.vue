  ...
  <div class="space-y-6">
    ...
    <template v-else>
      ...
      <div v-if="activeTab === 'access'" class="space-y-6">
          ...
          <div class="relative flex items-center justify-between">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-white/80">Master IP allowlist for the public 443 interface</p>
              </div>
            </div>
            <button
              @click="reloadNginx"
        ...
        <Card title="Allowed IP Ranges" subtitle="Only clients whose source IP falls in one of these ranges can reach GenMaster on the public 443 interface. Anything not listed is denied with HTTP 403.">
              ...
              <div class="flex gap-3">
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm text-blue-700 dark:text-blue-400">
                    This list is the master allowlist for the entire GenMaster web interface on port 443. Only clients whose IP falls in one of these ranges can reach the UI, the API, the websocket, the health endpoint, or Portainer — any other source returns HTTP 403.
                    The defaults already cover loopback, RFC1918 private networks, Docker bridges, and Tailscale's CGNAT range, so on-LAN and Tailscale clients work automatically. Add a custom range to permit a specific public IP (for example, your phone's mobile carrier address). To lock things down further, leave only what you trust here and reach the UI exclusively over Tailscale.
