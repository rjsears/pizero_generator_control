          ...
          <div class="p-4 rounded-lg bg-surface-hover">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                <p class="text-xs text-muted mt-1">
                  IP address of the GenSlave device. Use a literal IPv4 address (avoid hostnames &mdash; DNS issues will break the link). For best stability, configure GenSlave with a matching static IP.
                </p>
              </div>
              <div>
              ...
              <div class="flex items-center gap-4">
                <label class="flex items-center gap-2 text-sm text-secondary">
                  <input
                    ...
                    type="radio"
                    value="dhcp"
                    name="addNetworkIpMethodGenSlave"
...
const addNetworkStaticAddress = ref('')
const addNetworkStaticGateway = ref('')
const addNetworkStaticDns = ref('')
...
async function addKnownNetwork(acknowledgeWarning = false) {
  ...
  try {
    const response = await genslaveApi.addWifiNetwork(payload)
