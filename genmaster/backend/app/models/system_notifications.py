...
DEFAULT_SYSTEM_NOTIFICATION_EVENTS = [
    ...
    # EPO + HOA Hardware-Switch Events (Phase 5).
    # Kept in sync with migration 020 — fresh installs seed from this
    # list, upgraded installs get the same rows via the migration.
    {
