...
async def add_event_target(
    ...
    # Validate that the referenced channel/group exists, and capture the name
    # for the response so we don't have to lazy-load the relationship later
    # (lazy loads aren't allowed in async SQLAlchemy sessions).
    target_name = "Unknown"
