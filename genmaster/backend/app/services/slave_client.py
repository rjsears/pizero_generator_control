...
class SlaveClient:
    ...
    async def get_reboot_schedule(self) -> SlaveResponse:
        """Get the scheduled reboot configuration."""
        return await self._request("GET", "/api/system/reboot-schedule")

    async def set_reboot_schedule(
        self,
        enabled: bool,
        day: str,
        hour: int,
        ...
        """Set the scheduled reboot configuration."""
        return await self._request(
            "POST",
    ...
    async def set_reboot_schedule_enabled(self, enabled: bool) -> SlaveResponse:
